...
export function ToggleAtendimentoHumano({
  ...
  if (humano) {
    return (
      <button
        onClick={handleClick}
        disabled={pending}
        className="flex h-[34px] shrink-0 items-center justify-center gap-2 rounded-[999px] border border-[rgba(168,85,247,0.3)] bg-[rgba(168,85,247,0.1)] px-5 disabled:opacity-50"
      >
  ...
  return (
    <button
      onClick={handleClick}
      disabled={pending}
      className="flex h-[34px] shrink-0 items-center justify-center gap-2 rounded-[999px] px-5 text-white shadow-[0px_14px_32px_-14px_rgba(168,85,247,0.5)] disabled:opacity-50"
